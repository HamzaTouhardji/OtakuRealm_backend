...
from .views import RegisterAPI, InfoUser,TopAnimeAllTime, UtilisateurViewSet, RecommandationViewSet,  LoginAPI, AnimeList, CustomAuthToken, AnimeDetails, GenericAPIView, GenreList, UserList
